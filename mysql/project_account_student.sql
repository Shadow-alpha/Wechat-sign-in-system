...
CREATE TABLE `account_student` (
  ...
  `password` varchar(30) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '123456' COMMENT '密码',
  PRIMARY KEY (`stu_id`),
  CONSTRAINT `fk_stu_id_account` FOREIGN KEY (`stu_id`) REFERENCES `student_info` (`stu_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='学生账户表';
...
INSERT INTO `account_student` VALUES ('21312345678','123456');
